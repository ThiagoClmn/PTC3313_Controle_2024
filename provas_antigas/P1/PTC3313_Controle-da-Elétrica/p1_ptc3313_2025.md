...
$$
\text{FTMF}_1 = \dfrac{G_2(s)}{1+G_2(s)\cdot s}
$$

$$
\therefore \text{FTMF}_1 = \dfrac{0,5(s-2)}{s(s+3,5)}
$$

Essa função de transferência está em série com $G_1(s)$, formando a planta:

$$
G_3(s) = \text{FTMF}_1 \cdot G_1(s)
$$
...
$$
\text{FTMF} = \dfrac{K(s-2)(s+1)}{2s^2(s+3,5) + K(s-2)(s+1)}
$$

$$
\therefore \dfrac{C(s)}{R(s)} = \text{FTMF} = \dfrac{K(s-2)(s+1)}{2s^3 + (K-7)s^2 - Ks - 2K}
$$
...
1   | c1   | c2 | 0
```
$$ b_1 = \dfrac{-(2\cdot(-2K) - (-K)(K-7))}{K-7} $$
$$\implies b_1 = \dfrac{K(11 - K)}{K-7} $$

$$ b_2 = \dfrac{-(2\cdot 0 - 0 \cdot(K-7))}{K-7} = 0 $$

$$ c_1 = \dfrac{-(b_2 \cdot (K-7) - b_1 \cdot (-2K))}{b_1} $$
$$ c_1 = -\dfrac{b_2}{b_1} \cdot (K-7) - 2K = -2K$$
...
### b) Compensador e polos

...

### c) Parâmetros por LGR
...
<p align="center">
    <!-- <img src="../img/p1_ptc3313_2025_q3_blocos.png" alt="Diagrama de blocos em MF com compensador e planta" width="500"> -->
    <strong>[ GRÁFICO SERÁ ADICIONADO AQUI ]</strong>
</p>
...
$$
\omega_n = \dfrac{p+4}{2\xi}
$$

$$
\omega_n = \dfrac{p+4}{2\cdot 0.5}
$$
