...
c) É possível projetar um controlador proporcional, i.e., $G_c(s) = k$, tal que o tempo de acomodação ($2\%$) do sistema em malha fechada seja $t_s(2\%) \approx 1.0s$ e o sobressinal máximo seja 1.52%? Justifique utilizando o Lugar das Raízes.
**(Valor: 1,0)**
...
b) Frequência natural não amortecida, coeficiente de amortecimento, sobressinal e tempo de acomodação (2%) do sistema em malha fechada
...
$$
FTMF = \dfrac{1}{3}\dfrac{3}{s^2 +3s +3} = \dfrac{\omega_n^2}{s^2 + 2\xi\omega_n s + \omega_n^2}
$$
